      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              Discover my expertise in modern web development, AI integration, and premium software solutions.
            </motion.p>
            ...
            >
              <Button className="px-8 py-3 bg-slate-900 hover:bg-slate-800 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
                <Link href="https://abhisek-7.vercel.app/" className="flex items-center gap-2">
                  View My Work
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                A comprehensive showcase of modern web development expertise, built with industry-leading technologies
              </p>
              <p className="text-lg text-slate-500 leading-relaxed">
                This project demonstrates my complete skill set in practice, not just theoretical knowledge. 
                Every component, every integration, every line of code represents real-world application 
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
                ...
                <p className="text-sm text-slate-600">Enterprise-grade code quality</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
                ...
                <h4 className="font-semibold text-slate-900 mb-1">Modern Stack</h4>
                <p className="text-sm text-slate-600">Latest technologies & practices</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-slate-200">
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-slate-900">Full-Stack Excellence</h4>
                    <p className="text-slate-600">End-to-end development mastery</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-slate-700">TypeScript & Tailwind CSS</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                    <span className="text-slate-700">AI Integration & Payments</span>
                  </div>
                  <div className="flex items-center gap-3">
            ...
            >
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 h-full text-center group-hover:border-amber-200 border border-slate-200">
                ...
                <p className="text-sm text-slate-500">
                  {feature.name === "Authentication" && "Secure user management"}
                  {feature.name === "Dashboards" && "Interactive data visualization"}
                  {feature.name === "Charts and Graphs" && "Beautiful data representation"}
                  {feature.name === "Ai Integration" && "OpenAI & Gemini API integration"}
                  {feature.name === "Database" && "PostgreSQL with modern ORMs"}
                  {feature.name === "File Uploads" && "Seamless file handling"}
                  {feature.name === "Payment integration" && "Stripe payment processing"}
                  {feature.name === "Vercel deployment" && "Production-ready deployment"}
                </p>
              </div>
            </motion.div>
          ))}
    ...
    <section id="pricing" className="py-20 px-6 bg-white ">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Choose the perfect plan to unlock the full potential of AI-powered PDF summarization
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                <div className={`bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 h-full flex flex-col ${
                  isPro ? "border-2 border-amber-200" : "border border-slate-200"
                }`}>
